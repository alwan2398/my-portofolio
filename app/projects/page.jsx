...
const AllProject = () => {
  ...
  return (
    <Wrapper className="max-w-2xl w-full mx-auto lg:mb-24">
      <div className="flex flex-col items-start w-full mt-0 lg:mt-8">
        <AnimationContainer className="w-full flex flex-col gap-5 mb-8">
          ...
          <p className="text-base text-justify lg:leading-8 text-foreground/80">
            Berikut kumpulan karya saya yang mengubah ide menjadi nyata, solusi
            kerja. Dari alat yang berguna bagi pelajar hingga SaaS yang kreatif
            platform, proyek-proyek ini menunjukkan kecintaan saya pada
